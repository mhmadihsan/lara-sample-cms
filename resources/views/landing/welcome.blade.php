						...
						<div class="col-sm-12">
							<div class="main-banner">
								<div class="d-sm-flex justify-content-between">
                                    ...
                                    <img src="{{asset('mars/images/group.png')}}" alt="marsmello" class="img-fluid" data-aos="zoom-in-up">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="container">
					...
					<div class="row" data-aos="fade-up">
						<div class="col-sm-4 text-center text-lg-left">
                            ...
                            <img src="{{asset('/mars/images/integrated-marketing.svg')}}" alt="integrated-marketing" data-aos="zoom-in">
